                ...
                <div className="EditInventoryModal__container">
                    ...
                    <form onSubmit={onConfirm} >
                        <div className="EditInventoryModal__edit-section">
                            <TextField label='Item Name :' id='itemName'name='itemName' value={inventoryItemName} onChange={onItemNameChange} type='text' isRequired required isInline={true}/>
                            <TextField label='Initial Stock :' id='initialStock'name='initialStock' value={inventoryInitialStock} onChange={onInitialStockChange} type='text' isRequired required isInline={true}/>
                            <TextField label='Price :' id='price'name='price' value={inventoryPrice} onChange={onPriceChange} type='text' isRequired required isInline={true}/>
                            <TextField label='Borrowed :' id='borrowed'name='borrowed' value={inventoryBorrowed} type='text' readOnly isInline={true}/>
                            <TextField label='Returned :' id='returned'name='returned' value={inventoryReturned} type='text' readOnly isInline={true}/>
                            ...
                            <TextField label='Borrowable Stock :' id='borrowable'name='borrowable' value={inventoryBorrowable} onChange={onBorrowableChange} type='text' isRequired required isInline={true}/>
