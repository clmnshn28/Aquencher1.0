...
export const CreateAnnouncementModal = ({isOpen, onClose, onConfirm, announcementTitle, announcementSummary, handleAnnouncementTitleChange, handleAnnouncementSummaryChange}) => {
    ...
    return(
        <Modal>
            <div className="CreateAnnouncementModal__container">
                <h1  className="CreateAnnouncementModal__header">Create Announcement</h1>
