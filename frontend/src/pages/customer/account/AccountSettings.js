...
export const AccountSettings = () =>{
    ...
    const [personalInfoItems, setPersonalInfoItems] = useState([
        { label: 'Firstname', value: 'Francis Harvey' },
        { label: 'Lastname', value: 'Soriano' },
        { label: 'Username', value: 'havis' },
        { label: 'Contact No.', value: '09675710874' },
        { label: 'Email', value: 'francisharvey@gmail.com' },
    ]);
